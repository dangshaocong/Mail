...
# 可以访问后段的域名
ALLOWED_HOSTS = ['127.0.0.1', 'www.mall.com', 'api.mall.com', 'localhost']
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # CORS 解决跨域请求的
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            # 日志文件的位置
            'filename': os.path.join(os.path.dirname(BASE_DIR), "mall.log"),
...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    # ('*/5 * * * *', 'contents.crons.generate_static_index_html', '>> /Users/delron/Desktop/mall/logs/crontab.log')
